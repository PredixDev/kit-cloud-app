    ...
    _handleBubbleClick: function(evt) {
      ...
      function findMatchRecur(el) {
        ...
        if (utils.hasClass(el, 'hopscotch-close')) {
          return 'close'; }
        if (utils.hasClass(el, 'hopscotch-dontshowagain')) {
      ...
      } else if (action === 'dontshowagain') {
        localStorage.setItem('predixDontShowAgain', 'true');
      }
    },
    ...
    this["templates"]["bubble_default"] = function(obj) {
      ...
      with(obj) {
        ...
        __p += '\n<div class="hopscotch-bubble-container" style="width: ' +
          ...
          'px;">\n  ';
        /* Forced ommission of step number as tour.isTour seems unreliable */
        /*
         if(tour.isTour){ ;
        ...
        __p += '\n    ';
        /* Force showing "don't showthis again" bacause we're somehow unable to add through hopscotch options */
        __p += '<br>\n      <div class="hopscotch-checkbox hopscotch-dontshowagain">\n        <input type="checkbox" name="dontShowNextTime" value="dontShowNextTime">' +
