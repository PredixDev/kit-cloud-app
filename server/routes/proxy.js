...
// '/api/kit/register', 'https://unittest3-kit-service.run.aws-usw02-pr.ice.predix.io', '/device/register');
var customProxyMiddleware = function(pathPrefix, endpoint, targetPath) {
	...
	return expressProxy(endpoint, {
		...
		forwardPath: function (req) {
			...
			// TODO: test more, clean this up.
			if (req.url.indexOf(pathPrefix) > -1) {
